  ...
  return (
    <div className="space-y-6 p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div 
          className="rounded-xl border bg-card p-6 shadow-sm hover:shadow-lg transition-all cursor-pointer group"
          onClick={handleExportExcel}
        >
          <div className="flex items-start justify-between">
            <div className="space-y-3">
              <h3 className="font-semibold text-lg">Exportar para Excel</h3>
              <p className="text-sm text-muted-foreground">
                Gere uma planilha completa com todas as receitas, despesas e categorias
              </p>
              <Button className="gap-2 group-hover:scale-105 transition-transform" onClick={handleExportExcel}>
